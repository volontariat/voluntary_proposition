...
ActiveRecord::Schema.define(version: 20150819153144) do
  ...
  create_table "proposition_units", force: :cascade do |t|
    t.integer  "organization_id", limit: 4
    t.string   "ancestry",        limit: 255
    t.integer  "ancestry_depth",  limit: 4,   default: 0
    t.integer  "position",        limit: 4
  ...
  add_index "proposition_units", ["ancestry"], name: "index_proposition_units_on_ancestry", using: :btree
